...
class MenuUser:
    ...
    def visualizar_anotacoes(self):
        ...
        try:
            with open(f"anotacoes\{self.username}_anotacoes.txt", "r") as file:
    ...
    def adicionar_anotacao(self):
        ...
        if os.path.exists(f"anotacoes\{self.username}_anotacoes.txt"):
            with open(f"anotacoes\{self.username}_anotacoes.txt", "r") as file:
        ...
        with open(f"anotacoes\{self.username}_anotacoes.txt", "a") as file:
