...
from MenuUsuario import MenuUser
...
class Janela:
    ...
    def cadastrar_usuario(self):
        ...
        if self.nusuariox in self.usuarios:
            ...
            with open(f"./dir_anotacoes/{self.nusuariox}_anotacoes.txt", "w") as file:
    ...
    def validacao(self):
        ...
        if validado1 and self.usuarios[self.usuariolog] == senha:
            validado2 = True
            print("certo")
            self.usuario.delete(0,END)
            self.senha.delete(0,END)
            self.janela.destroy()
            menuuser = MenuUser(self.usuariolog)
            menuuser.abrir()
    ...
    def cadastro(self):
        ...
        if self.animcadastro ==660:
            ...
            self.lbLogCanva = CTkLabel(master=self.frameCadastro,
                                       ...
                                       text=None,
                                       bg_color="#1A1926",fg_color="transparent")
            self.lbLogCanva.place(x=45,y=70)
            ...
            self.nusuario.place(x=20,y=185)
